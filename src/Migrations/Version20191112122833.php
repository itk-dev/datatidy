 ...
 */
final class Version20191112122833 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE data_target (id INT AUTO_INCREMENT NOT NULL, data_flow_id INT NOT NULL, description LONGTEXT NOT NULL, data_target VARCHAR(255) NOT NULL, data_target_options LONGTEXT NOT NULL COMMENT \'(DC2Type:json)\', data LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:json)\', INDEX IDX_26911EE51ABD5BEA (data_flow_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
